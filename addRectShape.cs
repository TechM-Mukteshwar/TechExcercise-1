...
{
    [Activity(Label = "addRectShape")]
    public class addRectShape : View
    {
        ...
        public addRectShape(Context ctx) : base(ctx)
        {
            init(ctx);
        }

        public addRectShape(Context ctx, IAttributeSet attrs) : base(ctx, attrs)
        {
            init(ctx);
        }

        public addRectShape(Context ctx, IAttributeSet attrs, int defStyle) : base(ctx, attrs, defStyle)
        {
            init(ctx);
        }
        ...
        private void init(Context ctx)
        {
            ...
            mBitmap = BitmapFactory.DecodeResource(ctx.Resources, Resource.Drawable.touch_me);
            ...
            switch (e.ActionMasked)
            {
                ...
                case MotionEventActions.Down:
                    ...
                    if (points[0] == null)
                    {
                        ...
                        {
                            circles.Add(new ResizeCircle(Context, Resource.Drawable.check_me, pt));
                        }
                    }
                    else
                    {
